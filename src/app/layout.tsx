  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="microblading-la-roda";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Microblading La Roda - Plasmapen La Roda- Blaneliss Estética Avanzada"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="microblading-la-roda"
          data-primary-color="#e6da6c"
          defer
        ></script>
      </head>
